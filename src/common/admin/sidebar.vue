    ...
    >
      <div class="flex flex-col h-full overflow-hidden">
        ...
        >
          ...
          >
            <div
              class="bg-gradient-to-br from-blue-600 to-indigo-600 p-2 rounded-xl shadow-md shrink-0 transition-all duration-300"
            >
              <svg
            ...
            >
              <h1
                class="text-xl font-bold text-gray-900 tracking-tight leading-none"
              >
                JobHub
              </h1>
              <p
                class="text-[10px] font-semibold text-blue-500 uppercase tracking-wider mt-0.5"
              >
                Admin Portal
              </p>
            </div>
